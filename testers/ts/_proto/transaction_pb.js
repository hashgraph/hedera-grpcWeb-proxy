...
var transaction_body_pb = require('./transaction_body_pb.js');
...
proto.proto.Transaction.toObject = function(includeInstance, msg) {
  var f, obj = {
    body: (f = msg.getBody()) && transaction_body_pb.TransactionBody.toObject(includeInstance, f),
    sigs: (f = msg.getSigs()) && basic_types_pb.SignatureList.toObject(includeInstance, f),
...
proto.proto.Transaction.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new transaction_body_pb.TransactionBody;
      reader.readMessage(value,transaction_body_pb.TransactionBody.deserializeBinaryFromReader);
      msg.setBody(value);
      break;
    case 2:
      var value = new basic_types_pb.SignatureList;
      reader.readMessage(value,basic_types_pb.SignatureList.deserializeBinaryFromReader);
      msg.setSigs(value);
      break;
    case 3:
...
proto.proto.Transaction.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      transaction_body_pb.TransactionBody.serializeBinaryToWriter
    );
  }
  f = message.getSigs();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      basic_types_pb.SignatureList.serializeBinaryToWriter
    );
  }
  f = message.getSigmap();
  if (f != null) {
...
proto.proto.Transaction.prototype.getBody = function() {
  return /** @type{?proto.proto.TransactionBody} */ (
    jspb.Message.getWrapperField(this, transaction_body_pb.TransactionBody, 1));
};
...
proto.proto.Transaction.prototype.getSigs = function() {
  return /** @type{?proto.proto.SignatureList} */ (
    jspb.Message.getWrapperField(this, basic_types_pb.SignatureList, 2));
};
...
proto.proto.Transaction.prototype.getSigmap = function() {
  return /** @type{?proto.proto.SignatureMap} */ (
    jspb.Message.getWrapperField(this, basic_types_pb.SignatureMap, 3));
};
