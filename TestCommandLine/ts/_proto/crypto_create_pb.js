...
proto.proto.CryptoCreateTransactionBody.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    shardid: (f = msg.getShardid()) && basic_types_pb.ShardID.toObject(includeInstance, f),
    realmid: (f = msg.getRealmid()) && basic_types_pb.RealmID.toObject(includeInstance, f),
    newrealmadminkey: (f = msg.getNewrealmadminkey()) && basic_types_pb.Key.toObject(includeInstance, f),
    memo: jspb.Message.getFieldWithDefault(msg, 13, ""),
    maxAutomaticTokenAssociations: jspb.Message.getFieldWithDefault(msg, 14, 0)
  };
...
proto.proto.CryptoCreateTransactionBody.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 9:
      ...
      break;
    case 10:
      var value = new basic_types_pb.ShardID;
      reader.readMessage(value,basic_types_pb.ShardID.deserializeBinaryFromReader);
      msg.setShardid(value);
      break;
    case 11:
      var value = new basic_types_pb.RealmID;
      reader.readMessage(value,basic_types_pb.RealmID.deserializeBinaryFromReader);
...
proto.proto.CryptoCreateTransactionBody.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      10,
      f,
      basic_types_pb.ShardID.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      11,
      f,
      basic_types_pb.RealmID.serializeBinaryToWriter
    );
  }
...
proto.proto.CryptoCreateTransactionBody.prototype.getKey = function() {
  return /** @type{?proto.proto.Key} */ (
    jspb.Message.getWrapperField(this, basic_types_pb.Key, 1));
};
...
proto.proto.CryptoCreateTransactionBody.prototype.getShardid = function() {
  return /** @type{?proto.proto.ShardID} */ (
    jspb.Message.getWrapperField(this, basic_types_pb.ShardID, 10));
};
...
proto.proto.CryptoCreateTransactionBody.prototype.getRealmid = function() {
  return /** @type{?proto.proto.RealmID} */ (
    jspb.Message.getWrapperField(this, basic_types_pb.RealmID, 11));
};
...
proto.proto.CryptoCreateTransactionBody.prototype.getNewrealmadminkey = function() {
  return /** @type{?proto.proto.Key} */ (
    jspb.Message.getWrapperField(this, basic_types_pb.Key, 12));
};
 ...
 * @return {string}
 */
proto.proto.CryptoCreateTransactionBody.prototype.getMemo = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 13, ""));
};


/** @param {string} value */
proto.proto.CryptoCreateTransactionBody.prototype.setMemo = function(value) {
  jspb.Message.setProto3StringField(this, 13, value);
};


/**
 * optional int32 max_automatic_token_associations = 14;
 * @return {number}
 */
proto.proto.CryptoCreateTransactionBody.prototype.getMaxAutomaticTokenAssociations = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 14, 0));
};


/** @param {number} value */
proto.proto.CryptoCreateTransactionBody.prototype.setMaxAutomaticTokenAssociations = function(value) {
