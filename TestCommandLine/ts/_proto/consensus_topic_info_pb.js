...
proto.proto.ConsensusTopicInfo.prototype.getAutorenewaccount = function() {
  return /** @type{?proto.proto.AccountID} */ (
    jspb.Message.getWrapperField(this, basic_types_pb.AccountID, 8));
};
...
/**
 * optional bytes ledger_id = 9;
 * @return {!(string|Uint8Array)}
 */
proto.proto.ConsensusTopicInfo.prototype.getLedgerId = function() {
 ...
 * @return {string}
 */
proto.proto.ConsensusTopicInfo.prototype.getLedgerId_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getLedgerId()));
};
 ...
 * @return {!Uint8Array}
 */
proto.proto.ConsensusTopicInfo.prototype.getLedgerId_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getLedgerId()));
};
...
/** @param {!(string|Uint8Array)} value */
proto.proto.ConsensusTopicInfo.prototype.setLedgerId = function(value) {
